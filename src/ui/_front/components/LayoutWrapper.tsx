...
export default function LayoutWrapper({
    ...
    return (
        <div
            className={twMerge(
                `
                grid [grid-template-areas:'main''footer''header'] grid-rows-[1fr_auto_auto] min-h-dvh w-full
                md:[grid-template-areas:'header''main''footer'] md:grid-rows-[auto_1fr_auto]
